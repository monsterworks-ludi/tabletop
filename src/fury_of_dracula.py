...
IBERIA_ROAD_MATRIX = am.build_matrix(IBERIA_CITIES, IBERIA_ROAD_CONNECTIONS)
IBERIA_RAIL_MATRIX = am.build_matrix(IBERIA_CITIES, IBERIA_RAIL_CONNECTIONS)
...
ROAD_MATRIX = am.build_matrix(SPACES, ROAD_CONNECTIONS)
YELLOW_MATRIX = am.build_matrix(SPACES, YELLOW_RAIL_CONNECTIONS)
WHITE_MATRIX = am.build_matrix(SPACES, WHITE_RAIL_CONNECTIONS)
SEA_MATRIX = am.build_matrix(SPACES, SEA_CONNECTIONS)
TRAVEL_MATRIX = (
    IDENTITY_MATRIX
    + ROAD_MATRIX
