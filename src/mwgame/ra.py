...
if __name__ == "__main__":
    ...
    for row in range(5):
        for col in range(5):
            print(f"{expected0[row][col]}, {expected1[row][col]}, {expected2[row][col]} &")
        print(f"\\\\\n")
